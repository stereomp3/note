...
# precision
print('The precision of the KNN is', "{:.3f}".format(metrics.precision_score(prediction, Y_test)))

# recall
print('The recall of the KNN is', "{:.3f}".format(metrics.recall_score(prediction, Y_test)))

# f1 score
res = f1_score(Y_test, prediction)
print('The f1_score of the KNN is', "{:.3f}".format(res))

# sensitivity
sensitivity = confusion[0, 0] / (confusion[0, 0] + confusion[0, 1])
print('The sensitivity of the KNN is', "{:.3f}".format(sensitivity))

# specificity
specificity = confusion[1, 1] / (confusion[1, 0] + confusion[1, 1])
print('The specificity of the KNN is', "{:.3f}".format(specificity))

# auc
print('The roc_auc_score of the KNN is', "{:.3f}".format(metrics.roc_auc_score(prediction, Y_test)))
